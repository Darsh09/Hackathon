...
<head>
    ...
    <title>Modern Farmer: Buy and Sell Farm Product Online</title>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style = "padding-right:100px; "><strong>ModernFarmer</strong></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<li style = "padding-top: 10px;">
					...
					<button type="submit" formaction="/checkout.php" name = "checkout" class = "btn" style = "float: right; background: #f9a023;" ><strong>Proceed to CheckOut</strong></button>
	...
	<div class="row text-center">
		...
		<?php
			...
			<div class = "thumbnail" align = "center">
				...
				<h4 class = "text-danger">Price: Rs<?php echo $row["Prcie"]; ?></h4>
